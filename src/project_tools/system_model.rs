                ...
                SystemProtocol {
                    ...
                    request_fields: vec![
                        ...
                        SystemProtocolField {
                            ...
                            description: "chat input for chat_send".to_string(),
                        },
                        SystemProtocolField {
                            name: "focus".to_string(),
                            required: false,
                            field_type: "string".to_string(),
                            description: "target/focus hint for the request".to_string(),
                        },
                    ],
                    response_fields: vec![
                        SystemProtocolField {
                            ...
                            required: true,
                            field_type: "string".to_string(),
                            description: "wire response type".to_string(),
                        },
                        SystemProtocolField {
                            name: "message".to_string(),
                            required: false,
                            field_type: "string".to_string(),
                            description: "acknowledgement or error summary".to_string(),
                        },
                    ],
